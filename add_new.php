...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `item`(`id`, `name`, `title`, `content`) VALUES (NULL,'$name','$title','$content')";

    $result = mysqli_query($conn,$sql);

    if($result){
        header("Location: forum.php?msg=Nowe zapytanie utworzone pomyślnie");
    }else{
...
<body id="page-top">
    ...
    <div class="container">
        <div class="text-center mt-5">
            ...
            <p class="text-muted">Podziel się z nami swoim problemem</p>
        </div>
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vh; min-width:300px;">
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Przykładowy tytuł">
                </div>
                <div class="mb-3">
                        <label class="form-label">Treść:</label>
                        <textarea type="text" class="form-control" name="content" placeholder="Rozwinięcie swojej myśli"></textarea>
                </div>
                <div>
