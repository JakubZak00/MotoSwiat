    ...
    <article>
            ...
            <div class="row">
                <div class="col-lg-8 bg-light">
                    <ol class="list-group list-group-numbered text-dark my-3 ml-3">
                        ...
                        <div class="list-group-item list-group-item-action p-4 order d-flex">
                       ...
                       <?php if(isset($_SESSION['name']))
                        {?>
                            <div class="col-3 m-auto">
                                ...
                                <?php }?> 
                                <a href="add_new_comment.php?id=<?php echo $row['id']?>" class="btn btn-primary mb-2">Odpowiedz</a>
                    ...
                    <?php 
        $sqll =  $sql = "SELECT * FROM `item` WHERE parent_comment = $id";
        ...
        while ($roww = mysqli_fetch_assoc($resultt)) {
            ?>
                    <div class="list-group-item list-group-item-action p-4 order d-flex">
                        <div class="col-9">
                        <p class="d-flex ps-5"><img class="img-fluid img-brand d-block " src="assets/img/avatar.jpg" alt="avatar" /><span class="mx-2 mt-2"><?php echo $roww ['name']?></span></p>
                            <p class="ps-5"><?php echo $roww ['content']?></p>
                        
                        </div>
                         <?php if($_SESSION['name']==$roww['name'])
                        {?>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy; MotoŚwiat 2022</div>
